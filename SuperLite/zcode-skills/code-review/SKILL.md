---
name: code-review
description: "Use when reviewing changes before merge or delivery. 中文信号：\"评审一下这次的改动\"\"检查下改动\""
---
# Code Review
...
Anything in the repo that documents how code should be written — first `docs/规范.md` (the SuperLite convention), then `CODING_STANDARDS.md` / `CONTRIBUTING.md` if present.
