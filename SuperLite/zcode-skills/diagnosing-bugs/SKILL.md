...
description: "Use when a bug resists a first fix attempt, or the user reports something broken, throwing, failing, or slow - \"debug\", \"帮我调试\", \"为什么报错\", \"这个 bug 怎么回事\", performance regressions. 中文信号：\"帮我调试\"\"为什么报错\"\"这个 bug 怎么回事\""
---
# Diagnosing Bugs
