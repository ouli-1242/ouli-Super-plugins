---
name: research
description: "Use when the user wants a topic investigated against high-trust primary sources - official docs, API facts, current best practices, 攻略、政策、价格对比 (\"查一下文档\", \"查一下攻略\"). 中文信号：\"查一下文档\"\"查一下攻略\""
---
# Research
