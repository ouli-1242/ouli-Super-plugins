---
name: superlite
description: "Use when starting any conversation or task - the entry-point router for SuperLite, built for daily use and simple projects - writing and summarizing, research, decisions, plans, light coding. 中文信号：写东西、总结材料、查资料、做决定、做计划、修 bug、评审"
---
# SuperLite Router
