...
| 目录 | 包名 | 版本 | 说明 |
|---|---|---|---|
| [`FastGraph-MCP/`](FastGraph-MCP/) | [`fastgraph-mcp`](https://github.com/ouli-1242/FastGraph-mcp) | 0.2.0 | 轻量代码智能 MCP：AST + 增量索引 + 调用图 |
| [`Dhole-MCP/`](Dhole-MCP/) | [`dhole-mcp`](https://github.com/ouli-1242/dhole-mcp) | 14.1 | 网页抓取/爬取/反爬/PDF/搜索，8 个工具 |
