...
function brandMarkup() {
  // Local-only companion: no remote brand asset, no upstream version probe.
  // The manifest reader was dropped in v2.0.0 (plugin manifests deleted), which
  // had left this badge rendering "vunknown".
  return '';
}
