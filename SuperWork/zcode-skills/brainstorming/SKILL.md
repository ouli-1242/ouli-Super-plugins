---
name: brainstorming
description: "Use when the user's request is underspecified - a vague feature idea, a new project, or a design question where requirements are not yet settled. 中文信号：「加个功能」「我想做个…」「帮我设计…」「这个需求怎么做」"
---
