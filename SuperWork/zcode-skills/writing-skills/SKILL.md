...
- Trigger exemplars: the user's actual speech — Chinese primary + code-switching tech terms (review/debug/TDD/PR/ADR/MCP); granularity: 1 exclusive anchor word + 2-3 short phrases, scenario sentence only at ambiguous boundaries — full rules: `references/agent-docs.md`
