---
name: doc-index
description: "Use when a project has no docs/文档导航.md yet (the first artifact needs a home), or when the user asks to organize the project's docs / set up a doc index / \"建个文档导航\" / \"整理一下文档\"."
---
# Doc Index (文档导航)

## The Spine

`docs/文档导航.md` is the project's single index facade **and** the declaration of where each artifact type lives. Every producing skill (brainstorming, writing-plans, code-review, handoff, research, executing-plans, domain-modeling) follows this protocol:
...
实验记录结构（`docs/实验/` 无专属 skill，手动产出时按此）：假设 / 设置 / 指标 / 数据 / 结论 / 诚实边界；负结果照实记、合成数据不得宣称真实准确率、引用前重跑。
...
本项目用 SuperWork skill 套件（docs/ 中文文档约定）。开工前先读：
