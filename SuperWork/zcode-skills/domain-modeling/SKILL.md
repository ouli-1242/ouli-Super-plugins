...
description: "Use when the user wants to pin down domain terminology or a ubiquitous language, or record an architectural decision - \"统一术语\", \"这个词到底什么意思\", \"记个架构决策\", \"ADR\". 中文信号：\"统一术语\"\"这个词到底什么意思\"\"记个架构决策\""
---
# Domain Modeling
