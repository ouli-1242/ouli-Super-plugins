---
name: writing-plans
description: "Use when a design or spec has been approved and needs to be broken into a bite-sized implementation plan, before any code is written. 中文信号：\"拆任务\"\"做个实施计划\""
---
# Writing Plans
