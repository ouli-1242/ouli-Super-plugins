---
name: wps-cli
description: "Use when documents must be operated through the real WPS engine - live recalculation, field/TOC refresh, format-faithful export, or a document the user has open. 中文触发：「用wps-cli」"
---
