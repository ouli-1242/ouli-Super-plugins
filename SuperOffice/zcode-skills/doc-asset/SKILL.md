---
name: doc-asset
description: "Use when the user wants the agent to remember their organization's or personal document conventions. 中文信号：\"记住我们单位的模板\"\"以后都按这个格式\"\"把这份样例存下来\"\"记一下我们的术语\""
---
